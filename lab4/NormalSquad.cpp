...
NormalSquad::NormalSquad(std::string creatureName, std::string school, int initiative,
                         int speed, int damage, int protection, int count, int experience) : AmoralSquad(creatureName, school, initiative, speed, damage, protection, count, experience), moral(0) {
